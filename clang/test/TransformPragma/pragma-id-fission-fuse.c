...
// RUN: %clang                           -DMAIN                                   -std=c99            -O3 -mllvm -polly -mllvm -polly-position=early -mllvm -polly-process-unprofitable -mllvm -polly-use-llvm-names %s -o %t_pragma_pack%exeext
...
// IR: !7 = !{!"llvm.loop.fission.followup_fissioned", !8, !15}
...
// TRANS:   store double %p_conv, double* %scevgep, align 8, !alias.scope !21, !noalias !23
