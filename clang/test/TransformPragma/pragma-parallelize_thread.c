...
// RUN: %clang_cc1 -triple x86_64-pc-windows-msvc19.0.24215 -std=c99 -emit-llvm -O3 -mllvm -polly -mllvm -polly-position=early -mllvm -polly-process-unprofitable -mllvm -polly-parallel -mllvm -polly-use-llvm-names -o - %s | FileCheck --check-prefix=TRANS %s
